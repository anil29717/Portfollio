...
const terminalLines = [
  ...
  { prompt: false, text: '' },
  { prompt: false, text: "Software Development Engineer (SDE) specializing in" },
  { prompt: false, text: "full-stack web development, scalable SaaS applications," },
  { prompt: false, text: "and business automation solutions. Experienced in building" },
  { prompt: false, text: "production-ready platforms across EdTech, HRMS, Payroll," },
  { prompt: false, text: "LMS, and E-Commerce domains using React.js, Node.js," },
  { prompt: false, text: "Express.js, and SQL databases. Passionate about solving" },
  { prompt: false, text: "complex problems through clean architecture, optimized" },
  { prompt: false, text: "systems, and user-focused software solutions." },
  { prompt: false, text: '' },
